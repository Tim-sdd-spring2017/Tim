...
module.exports = function() {
  ...
  var t1 = new Task("t1", 1000*3600, new Date(d+1000*3600*24));
  var t2 = new Task("t2", 2000*3600, new Date(d+1000*3600*18));
  var t3 = new Task("t3", 3000*3600, new Date(d+1000*3600*12));
  ...
  return (
    ...
    c.getEvents()[6].getTitle() === "TaskBlock" 
    // false
